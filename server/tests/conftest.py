...
PG_HOST = "127.0.0.1"
PG_PORT = 5433
# QF_TEST_DBNAME (travail en parallèle, RAPPORT AVANCEMENT/TRAVAIL_PARALLELE.md) :
# chaque piste rejoue cette suite sur SA PROPRE base sans modifier ce fichier
# commun aux trois — défaut inchangé (quincaillerie_test) pour le dépôt principal.
