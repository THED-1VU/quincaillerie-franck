...
**Moyenne indicative après le cycle 44 (C11 limiteur partagé) : ≈ 71 %** (C0 70, C1 90, C2 77, C3 77, C4 86, C5 72, C6 85, C7 60, C8 72, C9 60, C10 58, C11 73, C12 92, C13 60, C14 40).
