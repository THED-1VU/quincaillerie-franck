...
**Moyenne indicative après le cycle 27 (voyants de tableau de bord, portabilité C13, rôle caissier C3, numéro de facturier C5) : ≈ 65 %** (C0 55, C1 80, C2 65, C3 68, C4 72, C5 72, C6 85, C7 50, C8 70, C9 58, C10 55, C11 68, C12 80, C13 60, C14 40).
...
8. ~~**C3 (rôle caissier, point h)**~~ — **fait** au cycle 27 : diagnostic
   ...
   préfixe par site. **Reste** (questions non tranchées) : rapport
   « écarts de prix par vendeur » et son seuil de validation (question 5),
   vendeurs sans compte (question 3).
