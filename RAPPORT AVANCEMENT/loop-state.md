...
**Moyenne indicative après le cycle 48 (C13 test flaky) : ≈ 74 %** (C0 70, C1 90, C2 77, C3 77, C4 89, C5 72, C6 85, C7 60, C8 72, C9 60, C10 58, C11 78, C12 92, C13 63, C14 60).
